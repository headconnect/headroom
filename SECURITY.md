...
Use [GitHub's private vulnerability reporting](https://github.com/headconnect/rations/security/advisories/new) to report a vulnerability. Please do not open a public issue for it.
